...
<head>
    ...
    <link rel="stylesheet" href="https://app.asisteclick.com/css/bootstrap.min.css"/> 
...
<body> 
    ...
    <div class="container">
        <div class="row">
			<div class="col-md-12" style="margin-bottom: 20px;">
				...
				Ejemplo de adaptador de sockets en Javascript para el control de una conversación con un bot. Este bot habla en español y puede conversar varios tópicos, responder consultas científicas, realizar cálculos, buscar datos históricos y muchos más. 
			</div>
			<div class="col-md-12">
    ...
    // connects socket
    var socket = io.connect("https://desa-sockets.asisteclick.com", {transports: ['websocket']});  
